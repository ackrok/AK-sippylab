function beh = extract2AFCdataAK_old(varargin)
% Extract behavioral events from bonsai output table
% Task: 2AFC
%
% beh = extract2AFCdataAK_old(statetrans)
% beh = extract2AFCdataAK_old(filePath, fileNames)
%
% INPUT
...
% NOTE UPDATED FUNCTION AVAILABLE extract2AFCdataAK
