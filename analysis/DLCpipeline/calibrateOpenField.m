...
cd(filePath);
fprintf('Importing Video File. \n');
switch type
    case '.mp4'
        % import the video file and save 100th frame as image
...
[centerPixel, pix] = selectCenterAndScale(im);
...
%         'Specify known distance',[1 20],{num2str(pix),'40'});
% pix = str2double(answer{1});
% cm = str2double(answer{2});
% scale = cm/pix;
scale = 40/pix; % open field is ~40 cm wide
